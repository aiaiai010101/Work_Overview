...
- 为了满足内网开发需要，办公室电脑机子新建了一个环境叫work38，用的python3.8版本，删除了work环境。住处电脑也要同步
- 总体架构考虑做成四栏，最左侧目录树，第二栏台账正文markdown编辑器，第三栏参考资料栏，像obsidian那样做成标签组，可以展示参考资料的文档结构和台账正文，第四栏做成台账正文目录树，和第一栏一样，但是独立滚动。思路
是这样的，第一栏和第二栏相当于主工作台，第三栏和第四栏是参考资料工作台。第三栏是个标签组，可以切换台账正文和作为参考资料的目录树的节点文档结构。
